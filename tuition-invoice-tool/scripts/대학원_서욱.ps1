# =============================================================
#  2026학년도 후기 대학원 — 서욱(XU XU) 단건 발급기
...
function Duration([string]$deg,[string]$dept){ return 'Sep. 2026 – Feb. 2029' }
...
<div class='page inv'><div class='frame'>
  ...
  <table class='pay'>
    ...
    <tr><td class='k'>Payment Period <span class='en2'>납부기간</span></td><td>To be announced &nbsp;<span style='color:#6b7d70'>(추후 안내)</span></td></tr>
  </table>
