# =============================================================
#  2026학년도 후기 대학원 — 추가 합격자 발급기 (서욱 / 밀리예브 후시닛딘)
...
<div class='page inv'><div class='frame'>
  ...
  <table class='pay'>
    ...
    <tr><td class='k'>Payment Period <span class='en2'>납부기간</span></td><td>August 20 – 21, 2026 &nbsp;<span style='color:#6b7d70'>(2026. 8. 20. ~ 8. 21.)</span></td></tr>
  </table>
...
# ---------- 대상 (납부자 명단 기준) ----------
# 출처: 납부자 명단 ..._20260814 반영.xlsx  'Sheet1 (2)'  r237(서욱) / r236(밀리예브)
# 가상계좌: 학사행정 > 장학및등록금관리 > 가상계좌생성처리 (2026/후기추가모집/외국인특별전형)
# 서욱      : 수업연한 2년 6개월 (담당자 지시) / 장학 없음 / 계좌 870-400-579511
# 밀리예브   : 수업연한 2년 (원래대로) / TOPIK 4급 50% / 계좌 870-400-579441
$SRC = @(
  @{ ExNo='2026412417'; Ko='서욱'; En='XU XU'; Birth='1989-12-03'; Sex='남'
  ...
  @{ ExNo='2026412416'; Ko='밀리예브 후시닛딘'; En='MELIEV KHUSNIDDIN KHASAN UGLI'; Birth='1995-08-10'; Sex='남'
     ...
     Dur='Sep. 2026 – Aug. 2028'; DurYr='2년'
     Acct='870-400-579441' }
)
